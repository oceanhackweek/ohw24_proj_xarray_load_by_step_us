...
class DALoadByStep:
    ...
    @property
    def nbytes_in_each_element(self) -> int:
        """Size in bytes of each element in the array."""
        
        # da.dtype shows the dtype of the "unpacked" data, after applying
        #  scale_factor, add_offset, etc.
        # da.encoding.dtype is the "real" dtype, the one that was used to write
        #   the data to disk.
    ...
    @property
    def nbytes_in_whole_array(self) -> int:
        """Size in bytes of the whole array."""
        return self.da.size * self.nbytes_in_each_element
    
    @classmethod                                                                
    def _indexers_or_indexers_kwargs(cls, indexers, indexers_kwargs):           
